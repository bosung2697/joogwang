...
Route::get('/ventureawards', 'Product\VentureAwardsController@index');
Auth::routes();
...
//    NewsRoom Controller
    ...
    //    VentureAwards Controller
    Route::get('/ventureawards/', 'Admin\Product\AdminVentureAwardsController@index');
    Route::get('/ventureawards/create', 'Admin\Product\AdminVentureAwardsController@create');
    Route::get('/ventureawards/{id}/edit', 'Admin\Product\AdminVentureAwardsController@edit');
    Route::put('/ventureawards/{id}/update', 'Admin\Product\AdminVentureAwardsController@update')->name('admin.ventureawards.update');
    Route::delete('/ventureawards/{id}', 'Admin\Product\AdminVentureAwardsController@delete')->name('admin.ventureawards.delete');
    Route::post('/ventureawardsfileupload/', 'Admin\Product\AdminVentureAwardsController@awardsfileupload')->name('admin.ventureawards.store');
