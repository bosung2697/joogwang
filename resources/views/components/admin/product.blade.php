<div class="sidebar product-selector {{ preg_match('/\/admin\/productintro/', $_SERVER['REQUEST_URI'])||preg_match('/\/admin\/productintro.+/', $_SERVER['REQUEST_URI'])||preg_match('/\/admin\/equipment/', $_SERVER['REQUEST_URI'])||preg_match('/\/admin\/equipment.+/', $_SERVER['REQUEST_URI']) ? '' : 'hide'}}">
