...
@section('content')
    <div id='productintro' class="infoput">
        <div class="container">
            ...
            <form id="productintro-form" method="POST" action="{{route('admin.productintro.store')}}" enctype="multipart/form-data">
                {!!csrf_field()!!}
                <div class="row">
                    <table>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea id="content" class="form-control" name="content" cols="70" placeholder="제품소개 내용을 입력해주세요.">{{ old('content')}}</textarea>
