...
@section('content')
    ...
    <div class="askingpage">
        <div style="display:flex; justify-content: space-between; align-items: center;"><h3>수상실적 목록</h3>
            <div style="cursor:pointer; border:2px solid #e85254; background-color: #e85254; color:white; padding:0.5vw; font-size:1vw; -webkit-border-radius: 1vw;-moz-border-radius: 1vw;border-radius: 1vw;"onclick="location.href='{{url('/admin/awards/create')}}'">수상실적 추가</div></div>
        <hr/>
        <div>
            <table class="pagecontents">
                ...
                <tr>
                    ...
                    <th class="th2 table_date">수상실적 실적일</th>
                    <th class="th2 table_date">수상실적 수정일</th>
                    <th class="th2"></th>
                </tr>
                </thead>
                <tbody>
                @forelse($data as $value)
                    <tr class="tothedetailpage"
                        onclick="location.href='{{ url('admin/awards/'.$value->id.'/edit') }}'">
