...
@section('content')
    ...
    <div id="ventureawards" class="infoput">
        <div class="container" style="margin: 0 5%;">
            <h1 class="infoputheader"><strong>※ 인증수상 수정</strong></h1>
            <form id="ventureawards-form" method="POST" action="{{ route('admin.ventureawards.update', $data->id) }}"
                ...
                <div class="row">
                    <table>
                        ...
                        <tr>
                            <td class="datainput"><label for="awarded_date">인증수상 내용</label></td>
                            <td>
                        ...
                        <tr>
                            <td class="savebutton" colspan="2">
                                <button type="submit" form="ventureawards-form" class="btn btn-success">
                                    저장하기
                                </button>
                            </td>
                        </tr>
